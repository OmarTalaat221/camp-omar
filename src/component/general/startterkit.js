            ...
            <Card>
              ...
              <CardBody>
                <p>
                  ...
                  process, Camp For English provides useful features to kick start
                  your project development with no efforts !
                </p>
                <ul>
                  <li>
                    <p>
                      Camp For English provides you getting start pages with different
                  ...
                  <li>
                    <p>
                      Every components in Camp For English are decoupled, it means use
                ...
                <div className="code-box-copy">
                  ...
                  <pre>
                    <code className="language-html" id="example-head">
                      ...
                      Camp For English provides useful features to kick start your
                      project development with no efforts !&lt;/p&gt; &lt;ul&gt;
                      &lt;li&gt;&lt;p&gt;Camp For English provides you getting start
                      ...
                      components in Camp For English are decoupled, it means use only
