...
const GroupsList = () => {
  ...
  function handleSelectGroup(group_id) {
    ...
    axios
      .post(
        "https://campforenglish.net/camp_for_english/admin/home/select_group_levels.php",
        data_send
      )
      .then((res) => {
        console.log(res);
  ...
  function handleGetLevels() {
    axios
      .get(
        "https://campforenglish.net/camp_for_english/admin/content/select_levels.php"
      )
      .then((res) => {
        console.log(res);
        if (res?.data?.status === "success") {
  ...
  function handleGetStudents(branch_id) {
    axios
      .post(
        "https://campforenglish.net/camp_for_english/admin/home/select_student_with_remaining_sub.php",
        {
          branch_id: branch_id,
  ...
  function handleGroupGetStudents(group_id) {
    axios
      .post(
        "https://campforenglish.net/camp_for_english/admin/absence/select_student_to_chat.php",
        {
          group_id: group_id,
        }
      )
  ...
  function handleAssignGroupToLevel() {
    ...
    axios
      .post(
        "https://campforenglish.net/camp_for_english/admin/home/assign_level_group.php",
        dataSend
      )
      .then((res) => {
        console.log(res);
